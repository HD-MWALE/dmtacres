...
export async function generateStaticParams() {
  const slugs = teamData.flatMap((dept) =>
...
// Function to get member by slug
...
export default async function MemberPage({
  ...
  const otherMembers = members.filter((m) => m.slug !== slug);
